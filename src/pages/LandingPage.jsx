...
const demoCSS = `
  ...
  @media (max-width: 768px) {
    ...
    .sl-navbar-logo { height: 32px !important; }
    .sl-navbar-cta { padding: 10px 16px !important; font-size: 14px !important; white-space: nowrap !important; }
    .sl-hero { padding: 100px 0 60px !important; }
    .sl-hero-para { font-size: 16px !important; margin-bottom: 28px !important; }
    .sl-section-title { font-size: 26px !important; }
    .sl-section-sub { font-size: 15px !important; margin-bottom: 40px !important; }
    .sl-cta-h2 { font-size: 26px !important; }
    .sl-cta-p { font-size: 15px !important; }
    .sl-btn-large { padding: 14px 24px !important; font-size: 16px !important; }
  }
`;
    ...
    <nav style={{ ...styles.navbar, boxShadow: scrolled ? "0 2px 20px rgba(37,99,235,.1)" : "none" }}>
      <div style={{ ...styles.container, ...styles.navInner }}>
        <a href="#home" style={styles.logo} onClick={e => { e.preventDefault(); scroll("home"); }}>
          <img src="/skootlink-wordmark.png" alt="Skootlink" className="sl-navbar-logo" style={{ height: 52, width: "auto" }} />
        </a>
...
function Hero() {
  ...
  return (
    <section style={styles.hero} id="home" className="sl-hero">
      <div style={styles.container}>
        ...
        <p style={styles.heroPara} className="sl-hero-para">
        ...
        <div style={styles.heroBtns}>
          ...
          <a href="#how-it-works" className="sl-btn-large" style={{ ...styles.btnBase, ...styles.btnOutline, ...styles.btnLarge }}
...
function HowItWorks() {
  return (
    <section style={styles.sectionAlt} id="how-it-works">
      <div style={styles.container}>
        <h2 style={styles.sectionTitle} className="sl-section-title">How Skootlink Works</h2>
        <p style={styles.sectionSub} className="sl-section-sub">A simple, secure process for both vehicle owners and drivers</p>
...
function DemoSection() {
  ...
  return (
    <section style={styles.section} id="demo">
      <div style={styles.container}>
        <h2 style={styles.sectionTitle} className="sl-section-title">See Skootlink in Action</h2>
        <p style={styles.sectionSub} className="sl-section-sub">Watch how easy it is to rent a delivery vehicle or list your own – in under 2 minutes.</p>
...
function TrustSafety() {
  ...
  return (
    <section style={styles.section} id="trust">
      <div style={styles.container}>
        <h2 style={styles.sectionTitle} className="sl-section-title">Trust &amp; Safety</h2>
        <p style={styles.sectionSub} className="sl-section-sub">We've built the infrastructure to make peer-to-peer rentals safe and formal</p>
      ...
      <div style={styles.container}>
        <div style={styles.contentGrid} className="sl-content-grid">
          <div style={styles.contentCard}>
            ...
            <a href="#how-it-works" className="sl-btn-large" style={{ ...styles.btnBase, ...styles.btnOutline, ...styles.btnLarge, marginTop: 12 }}
              onClick={e => { e.preventDefault(); scroll("how-it-works"); }}
              onMouseEnter={e => (e.currentTarget.style.background = "#eff6ff")}
              onMouseLeave={e => (e.currentTarget.style.background = "transparent")}
            >Learn More</a>
  ...
  return (
    <section style={styles.sectionAlt} id="about">
      <div style={{ ...styles.container, textAlign: "center", maxWidth: 800, margin: "0 auto" }}>
        <h2 style={styles.sectionTitle} className="sl-section-title">About Skootlink</h2>
        {[
...
function DownloadCTA() {
  return (
    <section style={styles.ctaSection} id="download">
      <div style={styles.container}>
        <h2 style={styles.ctaH2} className="sl-cta-h2">Ready to Get Started?</h2>
        <p style={styles.ctaP} className="sl-cta-p">Join Skootlink and be part of the formal vehicle rental revolution in South Africa.</p>
...
function FAQ() {
  ...
  return (
    <section style={styles.section} id="faq">
      <div style={styles.container}>
        <h2 style={styles.sectionTitle} className="sl-section-title">Frequently Asked Questions</h2>
        <p style={styles.sectionSub} className="sl-section-sub">Everything you need to know about Skootlink — the formal way to rent vehicles for gig work</p>
  ...
  return (
    <section style={styles.section} id="contact">
      <div style={{ ...styles.container, maxWidth: 600, margin: "0 auto" }}>
        <h2 style={styles.sectionTitle} className="sl-section-title">Contact Us</h2>
        <p style={styles.sectionSub} className="sl-section-sub">Have questions? We'd love to hear from you.</p>
        {sent ? (
