...
import {
  ...
  Loader2, Star, Coins, ShieldCheck, Flag, Megaphone, Bell, Radar,
} from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { label: 'Automated Reminders',   path: '/admin/reminders',              icon: Bell },
  { label: 'Proximity Alerts',      path: '/admin/proximity-alerts',       icon: Radar },
